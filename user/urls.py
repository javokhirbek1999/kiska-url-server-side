...
urlpatterns = [
    ...
    path('password-reset-request/<str:username>/', views.RequestResetPasswordAPIView.as_view(), name='password-reset-request'),
    path('password-reset-confirmation/', views.ConfirmResetPasswordAPIView.as_view(), name='password-reset-confirm'),
    path('password-reset/<str:username>/', views.ResetPasswordAPIView.as_view(), name='password-reset'),
